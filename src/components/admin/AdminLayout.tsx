...
const navItems = [
  ...
  { to: "/admin/provider-accounts", label: "Provider accounts", icon: ServerCog },
  { to: "/admin/bank-accounts", label: "Bank accounts", icon: Landmark },
  { to: "/admin/beneficiaries", label: "Beneficiaries", icon: UserRoundCheck },
  { to: "/admin/kyc-reviews", label: "KYC/KYB", icon: ShieldCheck },
  { to: "/admin/compliance", label: "Compliance", icon: ScanSearch },
  { to: "/admin/rfi-cases", label: "RFI cases", icon: MessagesSquare },
  ...
  { to: "/admin/transaction-records", label: "Transactions", icon: ReceiptText },
