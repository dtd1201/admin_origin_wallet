...
const AdminRfiCases = () => {
  ...
  const canSubmit = detailQuery.data?.status === "requested" && detailQuery.data.submission_state === "approved";
            ...
            {!detailQuery.isLoading && detailQuery.data ? (
              <div className="space-y-4">
                ...
                <div className="rounded-3xl border border-slate-200 bg-slate-50 p-4">
                  ...
                  <Button type="button" className="mt-2 w-full" disabled={!canSubmit || submitMutation.isPending} onClick={() => setSubmitOpen(true)}><Send className="h-4 w-4" />Submit approved {detailQuery.data.scope === "customer" ? "Corporate" : "Transaction"} RFI</Button>
