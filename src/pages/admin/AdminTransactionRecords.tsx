    ...
    <div className="grid gap-6 2xl:grid-cols-[minmax(0,1.75fr)_minmax(360px,0.7fr)]">
      <Card className="rounded-[28px] border-0 shadow-[0_18px_60px_rgba(15,23,42,0.08)]">
        ...
        <CardContent className="space-y-4">
          ...
          <div className="overflow-hidden rounded-3xl border border-slate-200"><div className="overflow-x-auto"><Table className="min-w-[800px] table-fixed 2xl:min-w-0"><TableHeader><TableRow><TableHead className="w-[23%]">Record</TableHead><TableHead className="w-[11%]">Type</TableHead><TableHead className="w-[10%]">Direction</TableHead><TableHead className="w-[13%]">Amount</TableHead><TableHead className="w-[10%]">Fee</TableHead><TableHead className="w-[11%]">Status</TableHead><TableHead className="w-[14%]">Booked</TableHead><TableHead className="w-[8%] text-right">Detail</TableHead></TableRow></TableHeader><TableBody>
