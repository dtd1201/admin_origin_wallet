    ...
    <div className="grid gap-6 2xl:grid-cols-[minmax(0,1.7fr)_minmax(360px,0.7fr)]">
      <Card className="rounded-[28px] border-0 shadow-[0_18px_60px_rgba(15,23,42,0.08)]">
        ...
        <CardContent className="space-y-4">
          ...
          <div className="overflow-hidden rounded-3xl border border-slate-200"><div className="overflow-x-auto"><Table className="min-w-[760px] table-fixed 2xl:min-w-0"><TableHeader><TableRow><TableHead className="w-[18%]">Provider</TableHead><TableHead className="w-[12%]">Account</TableHead><TableHead className="w-[12%]">KYC</TableHead><TableHead className="w-[13%]">Compliance</TableHead><TableHead className="w-[13%]">RFI</TableHead><TableHead className="w-[20%]">Provider status time</TableHead><TableHead className="w-[12%] text-right">Detail</TableHead></TableRow></TableHeader><TableBody>
